...
public class ConfigurationLockInterceptor extends HandlerInterceptorAdapter {
    ...
    // visible for testing
    final ThreadLocal<GeoServerConfigurationLock.LockType> THREAD_LOCK = new ThreadLocal<GeoServerConfigurationLock.LockType>();
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        logger.warning("DEBUG LOCK: " + lockType);
